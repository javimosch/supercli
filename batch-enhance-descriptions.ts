...
const DESCRIPTIONS: Record<string, string> = {
  ...
  // More utilities
  "7zip": "7zip — high-ratio file archiver supporting 7z, ZIP, and RAR formats",
  "acme.sh": "acme.sh — ACME protocol client for Let's Encrypt certificate management",
  "acunetix": "Acunetix — web vulnerability scanner for automated security auditing",
  "aide": "AIDE — file and directory integrity checker for intrusion detection",
  "aircrack-ng": "Aircrack-ng — wireless network security assessment suite",
  "airsonic": "Airsonic — self-hosted music streaming media server",
  "alpine": "Alpine — lightweight email client for terminal-based mail management",
  "amavisd": "AMaViS — email content filter for virus and spam scanning",
  "anki": "Anki — spaced-repetition flashcard program for efficient study",
  "ansible": "Ansible — IT automation platform for configuration management and deployment",
  "ant": "Ant — Apache Ant build tool for Java project automation",
  "antiword": "Antiword — convert Word documents to plain text and PostScript",
  "apache": "Apache HTTP Server — robust web server for hosting websites and applications",
  "apktool": "Apktool — reverse engineering tool for decompiling Android APK files",
  "asciinema": "Asciinema — terminal session recorder for sharing command-line workflows",
  "aspell": "Aspell — interactive spell checker for multiple languages",
  "autoconf": "Autoconf — generate configure scripts for software build automation",
  "automake": "Automake — generate Makefile.in templates for build systems",
  "autossh": "Autossh — persistent SSH tunnel with automatic reconnection",
  "avrdude": "AVRDUDE — program AVR microcontrollers using a bootloader or programmer",
  "bandwhich": "Bandwhich — terminal bandwidth utilization monitoring tool",
  "bashtop": "Bashtop — terminal resource monitor for CPU, memory, and disk usage",
  "bat": "Bat — cat clone with syntax highlighting and Git integration",
  "bc": "bc — arbitrary precision calculator language for math operations",
  "bible": "Bible CLI — command-line Bible reader for scripture lookup and study",
  "bind": "BIND — DNS server implementation for domain name resolution",
  "binwalk": "Binwalk — firmware analysis tool for extracting file systems and images",
  "bmon": "Bmon — bandwidth monitor with real-time traffic visualization",
  "bpytop": "Bpytop — resource monitor with GPU support and process management",
  "broot": "Broot — terminal file manager with tree navigation and fuzzy file search",
  "btop": "Btop++ — resource monitor with GPU, disk, and network visualization",
  "caddy": "Caddy — web server with automatic HTTPS and simple configuration",
  "calibre": "Calibre — e-book library management and format conversion tool",
  "cargo-bloat": "Cargo-bloat — analyze Rust binary size to find space usage",
  "cargo-criterion": "Cargo-criterion — Rust benchmark runner with statistical reports",
  "cargo-expand": "Cargo-expand — expand Rust macros for debugging and inspection",
  "cargo-generate": "Cargo-generate — generate new Rust projects from templates",
  "cargo-insta": "Cargo-insta — Rust snapshot testing tool for review workflows",
  "cargo-udeps": "Cargo-udeps — find unused crate dependencies in Rust projects",
  "cargo-watch": "Cargo-watch — watch file changes and rebuild Rust projects",
  "celery": "Celery — distributed task queue for asynchronous job processing",
  "cheat": "Cheat — community-driven cheat sheets for command-line tools",
  "chezmoi": "Chezmoi — dotfile manager for declarative configuration across machines",
  "chuck": "ChucK — strongly-timed audio programming language for music",
  "clara": "Clara OCR — OCR text recognition system for extracting text from images",
  "clojure": "Clojure — Lisp dialect running on JVM for functional programming",
  "cmake": "CMake — cross-platform build system generator for C/C++ projects",
  "cockroach": "CockroachDB — distributed SQL database for cloud-native applications",
  "composer": "Composer — PHP dependency manager for managing libraries and packages",
  "couchdb": "CouchDB — Apache document-oriented NoSQL database server",
  "cowsay": "Cowsay — ASCII art talking cow for fun terminal messages",
  "cron": "Cron — time-based job scheduler for Unix-like operating systems",
  "cryptsetup": "Cryptsetup — LUKS disk encryption setup and management utility",
  "cvs": "CVS — Concurrent Versions System for version control",
  "darcs": "Darcs — distributed revision control system with interactive patches",
  "darktable": "Darktable — raw image editor for professional photography workflow",
  "deepL": "DeepL CLI — command-line client for DeepL machine translation API",
  "diff-so-fancy": "Diff-so-fancy — enhanced git diff output for readability",
  "django": "Django — high-level Python web framework for rapid development",
  "dnsmasq": "Dnsmasq — lightweight DNS forwarder and DHCP server for networks",
  "docker-compose": "Docker Compose — multi-container Docker application orchestration",
  "doctl": "Doctl — DigitalOcean CLI for cloud resource management",
  "dokku": "Dokku — self-hosted PaaS for deploying applications via git",
  "dotnet": ".NET — cross-platform framework CLI for building applications",
  "dpkg": "Dpkg — Debian package manager for installing and managing packages",
  "drush": "Drush — Drupal shell for site management and automation",
  "elasticsearch": "Elasticsearch — distributed search and analytics engine",
  "elixir": "Elixir — functional programming language for scalable applications",
  "elm": "Elm — functional language for building reliable web applications",
  "emoji": "Emoji CLI — command-line emoji picker and search utility",
  "erlang": "Erlang — concurrent programming language for fault-tolerant systems",
  "etcd": "etcd — distributed key-value store for service discovery and configuration",
  "exfat": "exFAT — extended FAT file system utilities for managing exFAT partitions",
  "exiftool": "ExifTool — read and write metadata for images and media files",
  "expect": "Expect — automate interactive command-line applications via scripts",
  "fabric": "Fabric — Python library for remote server automation and SSH tasks",
  "fastfetch": "Fastfetch — system information tool optimized for speed",
  "ffmpeg": "FFmpeg — multimedia framework for audio/video processing and transcoding",
  "fio": "Fio — flexible I/O tester for benchmarking storage performance",
  "flask": "Flask — lightweight Python web framework for building APIs and apps",
  "flatpak": "Flatpak — application sandboxing and distribution framework for Linux",
  "flyctl": "Flyctl — Fly.io CLI for deploying and managing cloud applications",
  "foreman": "Foreman — process manager for Procfile-based application services",
  "fzf": "Fzf — command-line fuzzy finder for interactive filtering and search",
  "gatsby": "Gatsby — React-based static site generator for fast websites",
  "gdb": "GDB — GNU debugger for analyzing and debugging compiled programs",
  "ghost": "Ghost — headless CMS for publishing and content management",
  "gimp": "GIMP — GNU Image Manipulation Program for photo editing",
  "glances": "Glances — cross-platform system monitoring with web interface",
  "gnuradio": "GNU Radio — software-defined radio signal processing toolkit",
  "gparted": "GParted — graphical partition editor for disk management",
  "gradle": "Gradle — build automation tool for JVM-based multi-language projects",
  "graphite": "Graphite — time-series metrics monitoring and graphing system",
  "graphql": "GraphQL — query language for APIs with type-safe schema system",
  "grunt": "Grunt — JavaScript task runner for automating build processes",
  "gulp": "Gulp — streaming JavaScript build system for automation",
  "helm": "Helm — Kubernetes package manager for deploying applications",
  "homebrew": "Homebrew — macOS package manager for command-line tools",
  "htop": "Htop — interactive process viewer for Unix system monitoring",
  "hugo": "Hugo — fast static site generator written in Go",
  "ifstat": "Ifstat — network interface bandwidth usage statistics tool",
  "iftop": "Iftop — real-time network bandwidth monitoring by connection",
  "imagemagick": "ImageMagick — image creation, editing, and conversion suite",
  "inkscape": "Inkscape — vector graphics editor for SVG design and illustration",
  "inotifywait": "Inotifywait — filesystem event monitoring for triggering actions",
  "iperf": "Iperf — network throughput measurement and bandwidth testing tool",
  "ipfs": "IPFS — InterPlanetary File System for decentralized file storage",
  "iptables": "Iptables — Linux firewall rule management for network filtering",
  "jdupes": "Jdupes — duplicate file finder with hardlink support",
  "jekyll": "Jekyll — static site generator with blog-aware features",
  "jenkins": "Jenkins — CI/CD automation server for building and deploying software",
  "jq": "Jq — lightweight JSON processor for command-line querying",
  "julia": "Julia — high-performance programming language for scientific computing",
  "karma": "Karma — JavaScript test runner for browser-based testing",
  "kibana": "Kibana — Elasticsearch data visualization and exploration dashboard",
  "kompose": "Kompose — convert Docker Compose files to Kubernetes resources",
  "ksh": "Ksh — KornShell with scripting and interactive capabilities",
  "lame": "Lame — MP3 audio encoder and decoder for sound processing",
  "lazygit": "Lazygit — terminal UI for git with visual branch management",
  "lazydocker": "Lazydocker — terminal UI for Docker container management",
  "libreoffice": "LibreOffice — free office suite CLI for document conversion",
  "lighthouse": "Lighthouse — web page quality auditing for performance and SEO",
  "logrotate": "Logrotate — rotate and compress log files for disk management",
  "logstash": "Logstash — server-side data processing for log collection",
  "lsof": "Lsof — list open files for process and network investigation",
  "ltrace": "Ltrace — trace library calls for dynamic program analysis",
  "lynx": "Lynx — text-based web browser for terminal browsing",
  "mailhog": "MailHog — SMTP testing tool for capturing and viewing test emails",
  "mailpit": "Mailpit — multi-platform email testing tool with web UI",
  "make": "Make — GNU build automation for compiling programs from source",
  "maple": "Maple CAS — computer algebra system for symbolic mathematics",
  "maven": "Maven — build and dependency management for Java projects",
  "mc": "Midnight Commander — terminal file manager with two-panel interface",
  "mcrypt": "Mcrypt — file encryption utility using symmetric ciphers",
  "md5deep": "Md5deep — recursive file hash computation for forensic analysis",
  "mercurial": "Mercurial — distributed version control for source code management",
  "meson": "Meson — fast build system for cross-platform software projects",
  "metasploit": "Metasploit — penetration testing framework for exploit development",
  "mg": "Mg — lightweight Emacs-like text editor for terminal editing",
  "minio": "MinIO — S3-compatible object storage for high-performance data",
  "mitmproxy": "Mitmproxy — interactive HTTPS proxy for traffic inspection",
  "mksh": "Mksh — MirBSD Korn shell for POSIX scripting",
  "mocha": "Mocha — JavaScript test framework for Node.js and browser testing",
  "modsecurity": "ModSecurity — web application firewall for HTTP traffic filtering",
  "monit": "Monit — process monitoring and system resource management daemon",
  "mosh": "Mosh — mobile shell with robust roaming and intermittent connectivity",
  "mosquitto": "Mosquitto — MQTT message broker for IoT messaging",
  "moses": "Moses SMT — statistical machine translation system for language translation",
  "mpd": "MPD — Music Player Daemon for server-side audio playback",
  "mplayer": "MPlayer — media player supporting wide range of video formats",
  "msmtp": "Msmtp — SMTP mail client for sending emails from command line",
  "mtr": "Mtr — network diagnostic combining traceroute and ping",
  "mutt": "Mutt — flexible email client for terminal-based mail management",
  "nagios": "Nagios — IT infrastructure monitoring for alerts and reporting",
  "nano": "Nano — simple command-line text editor for quick file editing",
  "ncdu": "Ncdu — disk usage analyzer with terminal interface",
  "ncmpcpp": "Ncmpcpp — music player client for MPD with visual interface",
  "neo4j": "Neo4j — graph database management system for connected data",
  "neomutt": "Neomutt — email client with enhanced features and modern UI",
  "netcat": "Netcat — TCP/IP networking utility for port scanning and data transfer",
  "nextcloud": "Nextcloud — self-hosted file sync and collaboration platform",
  "nexus": "Nexus — repository manager for storing software artifacts",
  "nginx": "Nginx — high-performance web server and reverse proxy",
  "ngrok": "Ngrok — secure tunnel for exposing local servers to the internet",
  "nload": "Nload — real-time network traffic and bandwidth monitoring",
  "nmcli": "Nmcli — NetworkManager CLI for network configuration management",
  "nmon": "Nmon — performance monitoring tool for CPU, memory, and disk",
  "nodemon": "Nodemon — file-watch auto-restart utility for Node.js development",
  "nomad": "Nomad — workload orchestrator for deploying applications across datacenters",
  "notmuch": "Notmuch — fast email search and tagging for maildir mailboxes",
  "ntp": "NTP — Network Time Protocol daemon for system clock synchronization",
  "numpy": "NumPy — numerical computing library for Python array operations",
  "nuget": "NuGet — .NET package manager for installing libraries and tools",
  "nvm": "Nvm — Node Version Manager for installing and switching Node.js versions",
  "openconnect": "OpenConnect — VPN client for connecting to Cisco and other VPNs",
  "openldap": "OpenLDAP — directory services implementation for LDAP authentication",
  "openresty": "OpenResty — web platform based on Nginx and Lua scripting",
  "openssh": "OpenSSH — secure shell suite for remote system administration",
  "openvpn": "OpenVPN — VPN client/server for secure network tunneling",
  "packer": "Packer — HashiCorp image builder for creating machine images",
  "pandoc": "Pandoc — universal document converter for markup formats",
  "pass": "Pass — standard Unix password manager with GnuPG encryption",
  "perl": "Perl — scripting language for text processing and system automation",
  "php": "PHP — web scripting language for dynamic content and applications",
  "picocms": "Pico CMS — flat-file content management system using Markdown",
  "pinentry": "Pinentry — GnuPG passphrase entry dialog for encryption",
  "pipenv": "Pipenv — Python dependency and virtual environment manager",
  "pkg-config": "Pkg-config — query library compilation flags for building software",
  "podman": "Podman — daemonless container engine for running OCI containers",
  "postgresql": "PostgreSQL — advanced relational database system with SQL compliance",
  "pulumi": "Pulumi — infrastructure as code with general-purpose languages",
  "puppet": "Puppet — configuration management for automating infrastructure",
  "pylint": "Pylint — Python code quality checker for style and errors",
  "qemu": "QEMU — machine emulator for running virtual machines and guests",
  "quran": "Quran CLI — command-line Quran reader with verse search and recitation",
  "rabbitmq": "RabbitMQ — message broker for reliable asynchronous messaging",
  "rack": "Rack — Ruby web server interface for building web applications",
  "rake": "Rake — Ruby build automation tool similar to Make",
  "rclone": "Rclone — cloud storage sync for file transfer across providers",
  "rdesktop": "Rdesktop — Remote Desktop Protocol client for Windows connections",
  "redis": "Redis — in-memory data structure store for caching and messaging",
  "redshift": "Redshift — display color temperature adjuster for eye comfort",
  "restic": "Restic — fast and secure backup tool with encrypted snapshots",
  "rkhunter": "Rkhunter — rootkit detection scanner for Linux security",
  "roundcube": "Roundcube — web-based email client with IMAP support",
  "rpm": "RPM — Red Hat Package Manager for installing and managing packages",
  "rsync": "Rsync — fast file synchronization for incremental transfers",
  "ruby": "Ruby — dynamic programming language for web and scripting",
  "salt": "SaltStack — configuration management and remote execution framework",
  "samba": "Samba — file and print sharing for Windows interoperability",
  "sass": "Sass — CSS extension language for stylesheet preprocessing",
  "scons": "SCons — software construction tool for build automation",
  "screen": "Screen — terminal multiplexer for persistent remote sessions",
  "sendmail": "Sendmail — mail transfer agent for email routing and delivery",
  "sentry": "Sentry — application performance monitoring and error tracking",
  "sfcbd": "sfcbd — small footprint CIM broker daemon for WBEM management",
  "singularity": "Singularity — container platform for HPC and scientific computing",
  "slurm": "Slurm — workload manager for HPC cluster job scheduling",
  "smb": "SMB — Samba message block file sharing protocol tools",
  "snap": "Snap — snap package manager for Linux application distribution",
  "socat": "Socat — multipurpose relay for bidirectional data transfer",
  "sox": "SoX — Sound eXchange audio processing and conversion tool",
  "spamassassin": "SpamAssassin — email spam filter using content analysis",
  "sphinx": "Sphinx — documentation generator for Python projects",
  "sqlite": "SQLite — self-contained SQL database engine for embedded use",
  "sqlmap": "SQLMap — automated SQL injection detection and exploitation",
  "ssdeep": "Ssdeep — fuzzy hashing for file similarity comparison",
  "sshfs": "SSHFS — mount remote directories over SSH file system",
  "sslscan": "SSLscan — SSL/TLS protocol scanner for security assessment",
  "strace": "Strace — system call tracer for debugging and analysis",
  "strongswan": "strongSwan — IPsec VPN solution for secure site-to-site tunnels",
  "subversion": "Subversion — centralized version control system",
  "suricata": "Suricata — network threat detection and intrusion prevention engine",
  "surya": "Surya OCR — document OCR engine for accurate text extraction",
  "svn": "SVN — Apache Subversion for version control and source management",
  "swagger": "Swagger — OpenAPI tools for API design and documentation",
  "syncthing": "Syncthing — continuous file synchronization across devices",
  "sysbench": "Sysbench — system performance benchmark for CPU, memory, and I/O",
  "syslog": "Syslog — syslog protocol logger for system event collection",
  "systemd": "Systemd — init system and service manager for Linux",
  "systemtap": "SystemTap — dynamic tracing tool for Linux kernel analysis",
  "tcsh": "Tcsh — enhanced C shell with command-line editing",
  "telegraf": "Telegraf — metrics collection agent for InfluxDB time-series data",
  "terraform": "Terraform — infrastructure as code for multi-cloud provisioning",
  "thunderbird": "Thunderbird — cross-platform email client with calendar support",
  "tidy": "Tidy — HTML and XML cleanup tool for fixing markup issues",
  "tig": "Tig — text-mode interface for git repository browsing",
  "tika": "Tika — Apache Tika content analysis toolkit for file metadata",
  "tinc": "Tinc — mesh VPN daemon for secure peer-to-peer networking",
  "tmux": "Tmux — terminal multiplexer for managing multiple shell sessions",
  "tomcat": "Tomcat — Apache Tomcat servlet container for Java web apps",
  "tor": "Tor — anonymous network for privacy-protected communications",
  "torah": "Torah CLI — command-line Torah reader for scripture study",
  "torbrowser": "Tor Browser — privacy-hardened web browser for anonymous browsing",
  "traceroute": "Traceroute — network path discovery to remote hosts",
  "treesheets": "TreeSheets — hierarchical spreadsheet and data organizer",
  "tshark": "TShark — terminal-based Wireshark for network packet analysis",
  "typescript": "TypeScript — typed superset of JavaScript that compiles to JS",
  "ufw": "UFW — uncomplicated firewall for managing iptables rules",
  "unison": "Unison — bidirectional file synchronization tool",
  "unrar": "Unrar — extract files from RAR archives",
  "unzip": "Unzip — extract files from ZIP archives",
  "uuid": "UUID — unique identifier generation utility for system IDs",
  "valgrind": "Valgrind — memory debugging and profiling tool for programs",
  "varnish": "Varnish — HTTP accelerator for caching and optimizing web content",
  "vault": "Vault — HashiCorp secrets management for sensitive data",
  "vifm": "Vifm — terminal file manager with vi-like key bindings",
  "virtualbox": "VirtualBox — x86 virtualization for running multiple operating systems",
  "vscode": "VS Code — Visual Studio Code editor from the command line",
  "watchdog": "Watchdog — filesystem event monitoring for automated workflows",
  "webpack": "Webpack — JavaScript module bundler for application builds",
  "weechat": "WeeChat — extensible IRC client for terminal chat",
  "whois": "Whois — domain registration and IP ownership lookup",
  "wireshark": "Wireshark — network protocol analyzer for packet inspection",
  "wordpress": "WordPress CLI — manage WordPress sites from the command line",
  "wp-cli": "WP-CLI — command-line interface for WordPress site management",
  "x11vnc": "X11vnc — VNC server for sharing X11 desktops remotely",
  "xdebug": "Xdebug — PHP debugger and profiler for development",
  "xdotool": "Xdotool — simulate X11 keyboard and mouse input",
  "xrdp": "xrdp — Remote Desktop Protocol server for Linux desktops",
  "xxd": "Xxd — hex dump and reverse utility for binary data",
  "youtube-dl": "Youtube-dl — download videos from YouTube and other sites",
  "yt-dlp": "Yt-dlp — feature-rich YouTube downloader with additional sites",
  "zabbix": "Zabbix — enterprise monitoring solution for networks and servers",
  "znc": "ZNC — IRC bouncer for persistent IRC connections",
  "zoneminder": "ZoneMinder — video surveillance system for camera management",
};
...
function enhanceDescription(plugin: Plugin): Enhancement {
  ...
  // Smart expansion: if description is already useful (>=10 chars), prepend tool name
  ...
  if (desc.trim().length >= 10) {
    ...
    const nameStartsDesc = normalizedName === descFirstWord.replace(/[-_.]/g, "");
    if (!nameStartsDesc) {
      return {
        name,
        current: description,
        suggested: `${name} — ${desc.charAt(0).toUpperCase() + desc.slice(1)}`,
        confidence: 85,
      };
    }
  }
...
async function main() {
  ...
  console.log(`  80-84: ${enhancements.filter((e) => e.confidence >= 80 && e.confidence < 85).length}`);
  console.log(`  70-79: ${enhancements.filter((e) => e.confidence >= 70 && e.confidence < 80).length}`);
