      ...
      if (!humanMode) {
        output({
          ...
          first_steps: [
            ...
            "supercli plan <namespace> <resource> <action>        # preview before executing",
            "supercli execute <plan_id>                          # execute a persisted plan",
            ...
            "supercli skills get jar-scripts:supercli-mastery    # read the full supercli mastery skill",
            "supercli skills get easyredmine-cli:quickstart       # example: read a plugin's skill",
            "supercli skills get context-mode:quickstart          # example: context-mode for large ops",
            "supercli skills get chainlink:quickstart             # example: task tracking skill",
          ],
          token_optimization: {
