...
| **Plugin scoring & curation** — Community-voted "verified" plugins | Quality signal for 6,000+ plugins | Better discovery |
...
**KPI target:** 6,000+ plugins (achieved), 15K GitHub stars, 50K monthly `npx supercli` runs.
...
| **MCP-native runtime** — SuperCLI as an MCP server itself (not just consuming MCP) | Any MCP client gets all 6,000+ tools for free | Network effects |
...
|------|-------|-----|-----------|------------|---------|
| 2026 H2 | OSS Supernova | $0 | — | 0 | 6,000+ (achieved) |
...
| Open-source clone emerges | Network effects (6,000+ plugins, 8,000+ commands), cloud layer, team features |
